...
$(function () {
    ...
    $("#right").on("mouseenter", ".node", function () {
        $(this).append('<img width="20" height="20" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1554181102879&di=10dc971e31a66a1b53eb1c60a7444d58&imgtype=0&src=http%3A%2F%2Fbpic.588ku.com%2Felement_origin_min_pic%2F00%2F44%2F43%2F0856d6f18227bd0.jpg"  style="position: absolute;" />');
        if ($(this).text() == "开始" || $(this).text() == "结束") {
            $("img").css("left", 80).css("top", 0);
        } else {
    ...
    var solidCircle = {
        ...
        isSource: true,	//是否可以拖动（作为连线起点）
        connector: ["Flowchart", {stub: [40, 60], gap: 10, cornerRadius: 8, alwaysRespectStubs: true}], //连接线的样式种类有[Bezier],[Flowchart],[StateMachine ],[Straight ]
        isTarget: true,		//是否可以放置（连线终点）
        //anchor: "AutoDefault",
